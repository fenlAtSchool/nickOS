...
for i in sqm:
    k.write("j = " + str(i) + "\n")
    k.write("fpos = [0,0,52+parseInt(api.getStandardChestItemSlot([0,0,52],0).attributes.customAttributes.pages[0])]\n")
    ...
    k.write("    }; fpos[2]++\n")
    k.write("}; api.setStandardChestItemSlot([0,0,52],0,'Book',1,undefined,{'customAttributes': {'pages': [(fpos[2] - 52).toString()]}})\n")
